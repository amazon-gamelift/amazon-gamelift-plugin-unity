...
namespace AmazonGameLift.Editor
{
    ...
    /// </summary>
    public class EC2DeploymentSettings
    {
        ...
        internal EC2DeploymentSettings(ScenarioLocator scenarioLocator, PathConverter pathConverter,
        ...
        {
            string launchPath = _coreApi.GetServerGamePath(exeFilePathInBuild, BuildOperatingSystem);
