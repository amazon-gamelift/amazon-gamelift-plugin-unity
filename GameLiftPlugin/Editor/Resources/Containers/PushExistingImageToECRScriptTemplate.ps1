<<<<<<< HEAD:GameLiftPlugin/Editor/Resources/Containers/PushExistingImageToECRScriptTemplate.ps1
...
if ($LastExitCode -eq 0)
  ...
  {
    echo "Docker push to Amazon ECR has failed."
>>>>>>> main:Editor/Resources/Containers/PushExistingImageToECRScriptTemplate.ps1
  }